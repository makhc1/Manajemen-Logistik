...
<div id="dashboard-view" class="page-view active">
                <div class="welcome-card card">
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80" alt="Liara Profile" class="avatar" style="width: 48px; height: 48px;">
                        <div>
                            <h2 style="font-size: 1.25rem; font-weight: 800; color: #0F172A;">Welcome, Liara</h2>
                            <p style="font-size: 0.85rem; color: #64748B;">Your specific Berdikari Jaya menu.</p>
                        </div>
                    </div>
