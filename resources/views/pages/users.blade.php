                ...
                <div class="card">
                    <div class="page-header-row">
                        <div>
                            ...
                            <p style="font-size: 0.85rem; color: #64748B; margin-top: 0.25rem;">Kelola hak akses dan peran (role) staf gudang Anda.</p>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <button onclick="editUser('{{ $user->id }}', '{{ addslashes($user->name ?? '') }}', '{{ addslashes($user->email ?? '') }}', '{{ addslashes($user->role ?? '') }}', '{{ addslashes($user->status ?? '') }}', '{{ addslashes($user->profile_image_url ?? '') }}')" class="btn-action" style="background: #F1F5F9; color: #3B82F6; padding: 0.4rem 0.6rem; margin-right: 0.25rem; display: inline-flex;"><i class="fa-solid fa-pen"></i></button>
